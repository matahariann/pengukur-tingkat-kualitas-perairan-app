...
export default function AdminKelolaStation({ histories, geoZones = [], waterTypes = [], filters = {} }) {
    ...
    const applyFilters = useCallback((overrides = {}) => {
        ...
        router.get("/admin/kelola-station", params, {
            preserveState: true,
            preserveScroll: true,
            replace: true,
        });
    ...
    const handleReset = () => {
        ...
        setSelectedStatus("");
        setSelectedMethod("");
        router.get("/admin/kelola-station", { per_page: perPage }, {
            preserveState: true,
            preserveScroll: true,
            replace: true,
        });
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-2 w-full md:w-auto">
                                ...
                                <div className="flex items-center gap-1 hidden sm:flex">
                                    {renderPageNumbers().map((page, index) => {
                                        ...
                                        const pageUrl = `/admin/kelola-station?${queryString}`;
