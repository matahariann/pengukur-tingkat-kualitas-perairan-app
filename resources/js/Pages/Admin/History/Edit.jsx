...
export default function AdminHistoryEdit({ geoZones, waterTypes, bioticFamilies, feedingTypes = [], initialData }) {
    ...
    const handleSubmit = (e) => {
        ...
        const previewPutUrl = `/admin/history/${data.id_history}?is_preview=1`;
    ...
    const handleSave = () => {
        const baseUrl = '/admin/history';
        const putUrl = `/admin/history/${data.id_history}`;
