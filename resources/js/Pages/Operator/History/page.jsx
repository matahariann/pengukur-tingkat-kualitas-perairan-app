...
export default function OperatorHistory({ histories }) {
                                            ...
                                            <tr key={history.id} className="hover:bg-blue-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-sm">
                                                    <div className="flex items-center justify-center gap-2">
                                                        <Link href={`/operator/history/${history.id}/result`} className="text-emerald-600 hover:text-emerald-900 bg-emerald-50 hover:bg-emerald-100 p-2 rounded-lg transition-colors flex items-center gap-2" title="Lihat Hasil">
                                                            <FaEye size={16} /> <span className="hidden xl:inline">Result</span>
                                                        </Link>
                                                        <Link href={`/operator/history/${history.id}/edit`} className="text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 p-2 rounded-lg transition-colors flex items-center gap-2" title="Edit Data">
                                                            <FaEdit size={16} /> <span className="hidden xl:inline">Edit</span>
                                                        </Link>
                                                        <button
                                                            onClick={(e) => {
                                                                e.preventDefault();
                                                                const printUrl = `/operator/history/${history.id}/result?print=1`;
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-2 w-full md:w-auto">
                                ...
                                <div className="flex items-center gap-1 hidden sm:flex">
                                    {renderPageNumbers().map((page, index) => {
                                        ...
                                        const pageUrl = `/operator/history?page=${page}&per_page=${perPage}`;
