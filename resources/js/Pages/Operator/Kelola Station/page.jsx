...
export default function OperatorKelolaStation({ histories }) {
                                            ...
                                            <tr key={history.id} className="hover:bg-blue-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-sm">
                                                    <div className="flex items-center justify-center gap-2">
                                                        ...
                                                        <Link href={`/operator/kelola-station/${history.id}/edit`} className="text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 p-2 rounded-lg transition-colors flex items-center gap-2" title="Edit Data">
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-2 w-full md:w-auto">
                                ...
                                <div className="flex items-center gap-1 hidden sm:flex">
                                    {renderPageNumbers().map((page, index) => {
                                        ...
                                        const pageUrl = `/operator/kelola-station?page=${page}&per_page=${perPage}`;
