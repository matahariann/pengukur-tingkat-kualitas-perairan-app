...
export default function OperatorHitungKualitasAir({ geoZones, waterTypes, bioticFamilies, feedingTypes = [], initialData, isHistoryView = false, resultData = null }) {
    ...
    const handleSubmit = (e) => {
        ...
        post('/operator/hitung-kualitas-air?is_preview=1', {
            transform: (data) => ({
                ...data,
    ...
    const handleSave = () => {
        post('/operator/hitung-kualitas-air', {
            transform: (data) => ({
                ...data,
                families: data.families.filter(f => f.id_family && f.id_family !== ""),
            }),
