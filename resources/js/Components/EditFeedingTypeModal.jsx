...
export default function EditFeedingTypeModal({
    isOpen,
    onClose,
    form,
    setForm,
            ...
            <div className="relative bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl max-w-md w-full transform transition-all animate-modal-appear overflow-hidden border border-white/30 max-h-[80vh] md:max-h-[90vh] mt-12 md:mt-0 overflow-y-auto">
                ...
                <div className="p-6">
                    <div className="text-center mb-4">
                        <div className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-yellow-500 via-amber-500 to-orange-500 rounded-2xl mb-3 shadow-xl border-4 border-white/30">
                        ...
                        <p className="text-white/80 text-sm mt-1">
                            Feeding Type (ID: {selectedParam?.id})
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <div className="flex gap-3 pt-2">
                            ...
                            <button
                                type="submit"
                                className="flex-1 bg-gradient-to-r from-yellow-600 via-amber-500 to-orange-500 text-white font-semibold py-2 px-4 rounded-lg hover:from-yellow-700 hover:via-amber-600 hover:to-orange-600 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group border border-white/20"
                            >
