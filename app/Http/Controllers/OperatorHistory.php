...
class OperatorHistory extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render("Operator/History/page", [
            'auth' => [
                'user' => [
                    'id' => $user->id,
                    'name' => $user->name,
    ...
    public function result($id)
    {
        ...
        return Inertia::render("Operator/History/Result", [
            'auth' => [
                'user' => [
                    'id' => $user->id,
                    'name' => $user->name,
    ...
    public function edit($id)
    {
        ...
        return Inertia::render("Operator/History/Edit", [
            'auth' => [
                'user' => [
                    'id' => $user->id,
                    'name' => $user->name,
