...
class MemberHistory extends Controller
{
    ...
    public function result($id)
    {
        ...
        ])->where('id_user', $user->id)->findOrFail($id);
        ...
        return Inertia::render("Member/History/Result", [
            'auth' => [
                'user' => [
                    'id' => $user->id,
                    'name' => $user->name,
    ...
    public function edit($id)
    {
        ...
        return Inertia::render("Member/History/Edit", [
            'auth' => [
                'user' => [
                    'id' => $user->id,
                    'name' => $user->name,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $user_id = Auth::id();
            $result = \App\Models\Result::where('id_user', $user_id)->findOrFail($id);
            $result->update([
                'method' => $method,
                'value' => $finalValue,
                'status' => $status,
